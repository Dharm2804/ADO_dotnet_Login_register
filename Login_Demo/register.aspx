<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Login_Demo.Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="max-w-lg mx-auto mt-12 p-6 bg-white shadow-md rounded-lg">
        ...
        <div class="mb-6">
            <asp:Label Text="Name" runat="server" CssClass="block text-lg font-medium text-gray-700 mb-2"></asp:Label>
            <asp:TextBox ID="UserName" runat="server" CssClass="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"></asp:TextBox>
            <asp:RequiredFieldValidator ID="UserNameValidator" runat="server" ControlToValidate="UserName" 
                ErrorMessage="Name is required." CssClass="text-red-500 text-sm" Display="Dynamic"></asp:RequiredFieldValidator>
        </div>
        ...
        <asp:Button ID="RegisterButton" runat="server" Text="Register" CssClass="w-full bg-blue-500 text-white py-3 rounded-lg hover:bg-blue-600 transition duration-200" OnClick="RegisterButton_Click" />
        
        <div class="mt-6 text-center">
            <a href="/login.aspx" class="text-blue-500 hover:text-blue-700 hover:underline transition duration-200">Already have an account? Login</a>
        </div>
    </div>
</asp:Content>
